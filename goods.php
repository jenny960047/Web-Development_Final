...
<body>
	...
	<main class="container">
		<article class="showcase">
			<div class="video">
				<iframe style="border-radius: 10px;overflow: hidden;z-index: 1; margin-top: 15px;" width="680" height="381" src="https://www.youtube.com/embed/cT9EVHc0IPg?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
		</article>
		<aside class="imformation">
			<div id="frame">
			<div class="lable"><p>臺灣｜群眾募資｜設計</p></div>
			<div class="title"><p>你與毛孩共同的家【享貓小棧】｜大小空間都適用的模組收納架</p></div>
			<div class="author">
				<div>提案人</div>
				<a href="">MOODI WOOD</a>
			</div>
			<div class="description">
				<p>一款為毛孩也為你設計，真正兼顧兩方，能當跳台又不犧牲收納空間的模組收納架。打造你與毛孩的質感生活。</p>
			</div>

			<div class="dd">
				<div class="money">
					<div class="a">NT$652,448</div>
			...
			<div class="subtle">
				<div class="n">
					<div class="o">贊助人數</div><div class="m">252</div>
				</div>
				<div class="n">
					<div class="o">剩餘時間</div><div class="m">14 天</div>
				</div>
				<div class="n">
					<div class="o">時程</div><div class="m">2021/03/03 21:00 – 2021/04/21 23:59</div>
				</div>
				
			</div>
			<div class="social">
				<div>
					<button class="b1" onclick="location.href='order.php'">贊助專案</button>
				</div>
				<div>
	...
	<div class="nav">	
		<div class="bar">
			...
			<div class="select"><a href="">常見問題</a></div>
			<div class="select"><a href="">留言　23</a></div>
		</div>
	</div>
	<hr align=center width=80% color=#e6e6e6 SIZE=1>
	<div class="main">
		<div class="project">
			<div class="image"><IMG SRC=elements/goods-a.jpg width=80% 
				style="display:block; margin:auto; margin-bottom: 10px; border-radius: 10px;"></IMG></div>
			<div class="image"><IMG SRC=elements/goods-b.jpg width=80% 
				style="display:block; margin:auto; margin-bottom: 10px; border-radius: 10px;"></IMG></div>
			<div class="image"><IMG SRC=elements/goods-c.jpg width=80% 
				style="display:block; margin:auto; margin-bottom: 10px; border-radius: 10px;"></IMG></div>
			<div class="image"><IMG SRC=elements/goods-d.jpg width=80% 
				style="display:block; margin:auto; margin-bottom: 10px; border-radius: 10px;"></IMG></div>
			<div class="image"><IMG SRC=elements/goods-e.gif width=80% 
				style="display:block; margin:auto; margin-bottom: 10px; border-radius: 10px;"></IMG></div>
		</div>	
	</div>
	<br><br><br>
